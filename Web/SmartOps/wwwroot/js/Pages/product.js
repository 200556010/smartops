dtList = $('#' + dtTableName).DataTable({
    ...
    columns: [
        ...
        { name: 'CategoryName', data: 'categoryName', orderable: true, export: true },
        { name: 'Description', data: 'description', orderable: true, export: true },
        { name: 'Price', data: 'price', orderable: true, export: true },
        { name: 'Sku', data: 'sku', orderable: true, export: true },
        { name: 'StockQuantity', data: 'stockQuantity', orderable: true, export: true },
        {
